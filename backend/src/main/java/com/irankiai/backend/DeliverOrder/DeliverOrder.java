...
public class DeliverOrder {
    ...
    public void setTargetContainerIdForProductDelivery(
        Integer targetContainerIdForProductDelivery
    ) {
        this.targetContainerIdForProductDelivery =
            targetContainerIdForProductDelivery;
    }
}
